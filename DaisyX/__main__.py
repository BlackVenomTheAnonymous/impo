...
PM_START_TEXT = """
𝗔𝘀𝘀𝗮𝗹𝗮𝗺𝘂𝘄𝗮𝗹𝗮𝗶𝗸𝘂𝗺, 𝗠𝘆 𝗡𝗮𝗺𝗲 𝗜𝘀 𝗠𝗲𝗹𝗹𝗼 🤝

𝗜 𝗮𝗺 𝗮𝗻 𝗔𝗻𝗶𝗺𝗲 𝗧𝗵𝗲𝗺𝗲𝗱 𝗚𝗿𝗼𝘂𝗽 𝗠𝗮𝗻𝗮𝗴𝗶𝗻𝗴 𝗥𝗼𝗯𝗼𝘁🤖 𝗪𝗶𝘁𝗵 𝘃𝗲𝗿𝘆 𝗣𝗼𝘄𝗲𝗿𝗳𝘂𝗹🦾 𝗠𝗼𝗱𝘂𝗹𝗲𝘀 & 𝗜 𝗰𝗮𝗻 𝗵𝗲𝗹𝗽 𝘆𝗼𝘂 𝗶𝗻 𝗺𝗮𝗻𝗮𝗴𝗶𝗻𝗴 𝘆𝗼𝘂𝗿 𝗴𝗿𝗼𝘂𝗽👨‍💻

You can find my list of available commands by clicking following buttons

✪ Make sure you read *INFO* Section Below ✪ 

© 2020-2021 @GodFatherMob
"""
...
buttons = [
    ...
    [   InlineKeyboardButton(text="Developer ⚡️", url="https://t.me/GodFatherMob"),
    ],
    [
        InlineKeyboardButton(text="🧰 Support Admin 🧰",url="https://t.me/GodFatherMob"),
        InlineKeyboardButton(text="📺 Creator Admin 📺",url="https://t.me/DogeFatherMob"),   
    ],
    [    
        InlineKeyboardButton(text="➕ Add Shadow to Your Group 🎨", url="t.me/MelloTheRobot?startgroup=start"
        ),
    ],
]
...
Shadow is hosted on one of  Servers and doesn't require any donations as of now but You can donate to the original writer's of the Base code, 

Support them [Likhon Sheikh](t.me/GodFatherMob) & [Faria Sultana](t.me/DogeFatherMob)"""
...
def DaisyX_about_callback(update, context):
    ...
    if query.data == "aboutmanu_":
        query.message.edit_text(
            text=f"😍 *Hi again! My name is {dispatcher.bot.first_name}* \n\n*As  You I'm a next generational group management bot developed by Likhon Sheikh* "
            f"\n\n🔥Talk  [🛡Likhon Sheikh📝](https://t.me/GodFatherMob) To Keep Yourself Updated About {dispatcher.bot.first_name} 🔥"
        ...
        query.message.edit_text(
            text=f"* ｢ BASIC HELP 」*"
            f"\nYou can  add {dispatcher.bot.first_name} 🤖 to your chats by [Clicking Here](http://t.me/MelloTheRobot?startgroup=start) and selecting chat. \n"
            f"\n\nYou can get support {dispatcher.bot.first_name} by joining [🛡Faria Sultana📝](https://t.me/DogeFatherMob) also.\n"
            f"",
            parse_mode=ParseMode.MARKDOWN,
            disable_web_page_preview=True,
            reply_markup=InlineKeyboardMarkup(
        ...
        query.message.edit_text(
            ...
            f"\n\nBased on [Likhon](https://t.me/GodFatherMob) + [Faria](https://t.me/DogeFatherMob) ."
            f"\n\n{dispatcher.bot.first_name}'s Source code was written by \n[Likhon Sheikh](t.me/GodFatherMob)"
            f"\n\nIf Any Question About {dispatcher.bot.first_name}, \nLet Us Know At @GodFatherMob.",
            parse_mode=ParseMode.MARKDOWN,
            disable_web_page_preview=True,
            reply_markup=InlineKeyboardMarkup(
        ...
        query.message.edit_text(
            ...
            f"\n\nFor any kind of help, related to this bot, Join @GodFatherMob."
...
def Source_about_callback(update: Update, context: CallbackContext):
    ...
    if query.data == "source_":
        query.message.edit_text(
            text=""" Hi..[🤗](https://telegra.ph/file/3d2413222a9cbf3829235.jpg) I'm *Mello*.
                 \nYou can find the admin  by clicking below button scanning below QR code 👇👇👇👇 \n\n⚠️Don't forget to follow my owner [Likhon Sheikj](https://t.me/GodFatherMob) on Telegram⚠️""",
            parse_mode=ParseMode.MARKDOWN,
            disable_web_page_preview=False,
            reply_markup=InlineKeyboardMarkup(
                [
                 [
                    InlineKeyboardButton(text="The Mello🈵", url="https://t.me/GodFatherMob"),
                 ],
                 [
        ...
        update.effective_message.reply_text(
            ...
            reply_markup=InlineKeyboardMarkup(
                [
                    ...
                    [
                        InlineKeyboardButton(text="🧰 Support Chat 🧰", url="https://t.me/GodFatherMob")
                    ],
                ]
            ),
        )
...
def main():
    ...
    if SUPPORT_CHAT is not None and isinstance(SUPPORT_CHAT, str):
        try:
            dispatcher.bot.sendMessage(f"@MelloTheRobot", "I am now online🙋‍♂️")
        except Unauthorized:
            LOGGER.warning(
